...
public class ConnectionGraph {
 private LinkedList<Vertex> vertices;
    ...
    public void addEdge(User loggedInUser, String username2 ) {
        Vertex vertex1 = getVertex(loggedInUser.getUsername());
    ...
    public void removeEdge(User loggedInUser, String username2) {
        Vertex vertex1 = getVertex(loggedInUser.getUsername());
        Vertex vertex2 = getVertex(username2);
    ...
    private boolean vertexExists(String username) {
        for (Vertex vertex : vertices) {
